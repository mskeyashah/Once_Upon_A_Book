...
public class ReservingServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        title = title.replace(' ','+');
        	...
        	result = Test.doGet("reservingbook?title="+title+"&name="+first);
            
        
        if(result.contains("hold"))
        {
            htmlResponse+= "<p>The book has been put on hold for you.</p>";
        }
        else if(result.contains("already"))
        {
        	htmlResponse+="<p>The book has already been reserved for you.</p>";
        }
        else
            htmlResponse+= "<p>The book has been reserved for you.</p>";
